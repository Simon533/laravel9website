<x-admin-layout>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="flex p-2">
                <a href="{{route('admin.products.index')}}" class="px-2 py-2 bg-red-400 hover:bg-green-700 rounded-lg text-white">Products/home</a>
            </div>
            <div class="m-2 p-2">
...
<div class="w-full max-w-sm p-4 bg-white border border-gray-200 rounded-lg shadow-md sm:p-6 md:p-8 dark:bg-gray-800 dark:border-gray-700">
   <form method="POST"class="space-y-6" enctype="multipart/form-data"  action="{{route('admin.products.store')}}"  >
            @csrf
        ...
        <div>
         ...
         <div>
            ...
            <input type="number" name="price" id="price" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" placeholder="500shs,20shs" required>
        </div>
          <div>
            <label for="capacity" class="block mb-2 text-sm font-medium text-pink-40 dark:text-white">Capacity/Size here </label>
            <input type="capacity" name="capacity" id="capacity" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" placeholder="500shs,20shs" required>
        </div>
        <div>
        ...
        <div>
            <label for="description" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Products</label>
            <div class="mt-1">
                <select multiple>
